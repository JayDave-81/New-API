...
const News = (props) => {
    ...
    // &apiKey=2ac6be407463417490c84d1ac8b59838&page=1&pageSize=${props.pageSize}`;
    ...
    // let url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=2ac6be407463417490c84d1ac8b59838&page=${state.page - 1}
